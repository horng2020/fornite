function move() {
	...
	function frame() {
		...
		if (width > 60 && width < 70) {
			document.getElementById("progresslog").innerHTML = "Adding selected amount of Vbucks: "+lootbox+" Vbucks";
		}

		if (width > 80 && width < 90) {
			document.getElementById("progresslog").innerHTML = "Selected amount of "+lootbox+" Vbucks ready to be added";
		}
